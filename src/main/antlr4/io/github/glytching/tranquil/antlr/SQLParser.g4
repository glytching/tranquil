...
param
  : alias=Character_String_Literal EQUAL value=numeric_value_expression
  ;
...
array_accessor
  : LEFT_PAREN_SQUARE numeric_value_expression RIGHT_PAREN_SQUARE
  | LEFT_PAREN_SQUARE any_array_element RIGHT_PAREN_SQUARE
  ;

array_declaration
  : LEFT_PAREN_SQUARE RIGHT_PAREN_SQUARE
  ;

/* end - tranquil extension */
...
column_reference
  /* start - tranquil extension */
  : (tb_name=identifier (array_accessor)? DOT)*? name=identifier (array_accessor)?
  | (tb_name=identifier (array_declaration)? DOT)*? name=identifier (array_declaration)?
  /* end - tranquil extension */
...
sort_specifier
  : alias=row_value_predicand order=order_specification? null_order=null_ordering?
  ;
...
property
  : alias=Character_String_Literal EQUAL value=Character_String_Literal
  ;
...
property_key
  : alias=Character_String_Literal
;