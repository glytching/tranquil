...
public interface ParseContext {
  ...
  /**
   * Create a {@link ReadContext} for the given {@code source}. If you start with a {@code Map}
  ...
  /**
   * Create a {@link ReadContext} for the given input stream. If you start with an input stream
   * then use this as the entry point into Tranquil.
   *
   * @param sourceStream
   * @return
  ...
  /**
   * Create a {@link ReadContext} for the given input stream. If you start with an input stream,
   * in a specific charset, then use this as the entry point into Tranquil.
   *
   * @param sourceStream
   * @param charset
   * @return
  ...
  /**
   * Create a {@link ReadContext} for the given file. If you start with a file then use this as
   * the entry point into Tranquil.
   *
   * @param sourceFile
   * @return
   */
