...
/**
 * A Groovy specific implementation of {@link SelectClauseParser}. Example usage:
 *
 * <pre>
 *     GroovySelectClauseParser parser = new GroovySelectClauseParser();
 *
 *     String script = parser.get("a, b.c");
 * </pre>
 */
public class GroovySelectClauseParser extends SelectClauseParser<String> {
  ...
  public String parse(String expression) {
    final GroovySelectClauseListener listener = new GroovySelectClauseListener();
